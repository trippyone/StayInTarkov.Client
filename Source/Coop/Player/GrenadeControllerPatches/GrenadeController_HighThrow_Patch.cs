    ...
    internal class GrenadeController_HighThrow_Patch : ModuleReplicationPatch
    {
        ...
        public static void PostPatch(object __instance, EFT.Player ____player)
        {
            ...
            if (botPlayer != null)
            {
                ...
                {
                    PacketType = SITSerialization.GrenadePacket.GrenadePacketType.HighThrow
                };
            ...
            //AkiBackendCommunication.Instance.SendDataToPool(new GrenadeThrowPacket(____player.ProfileId, ____player.Rotation, "HighThrow").Serialize());
        }
