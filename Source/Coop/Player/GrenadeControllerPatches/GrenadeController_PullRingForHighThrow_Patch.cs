    ...
    internal class GrenadeController_PullRingForHighThrow_Patch : ModuleReplicationPatch
    {
        ...
        public static void PostPatch(object __instance, EFT.Player ____player)
        {
            ...
            if (botPlayer != null)
            {
                ...
                {
                    PacketType = SITSerialization.GrenadePacket.GrenadePacketType.PullRingForHighThrow
                };
            ...
            //AkiBackendCommunication.Instance.SendDataToPool(new GrenadeThrowPacket(____player.ProfileId, ____player.Rotation, "PullRingForHighThrow").Serialize());
        }
